...
struct DetailViewCinemark: View {
        ...
        VStack{
            ...
            VStack (alignment: .leading){
                HStack{
                    ...
                    Link("Call Merchant", destination: URL(string: "tel:8002463627")!)
                }
                HStack{
                    ...
                    Link("Merchant Website",
                         destination: URL(string: "https://www.cinemark.com")!)
                }
            }
            .padding(.top, 20)
            HStack{
...
struct DetailViewCinemark_Previews: PreviewProvider {
