        ...
        VStack{
            ...
            VStack (alignment: .leading){
                HStack{
                    ...
                    Link("Call Merchant", destination: URL(string: "tel:8003333991")!)
                }
                HStack{
                    ...
                    Link("Merchant Website",
                         destination: URL(string: "https://www.bp.com")!)
                }
            }
            .padding(.top, 20)
            HStack{
...
struct DetailViewBP_Previews: PreviewProvider {
