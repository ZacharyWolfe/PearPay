...
struct DetailViewPlatinumCard_Previews: PreviewProvider {
    static var previews: some View {
        DetailViewPlatinumCard(showDetailPlatinumView: .constant(false))
    }
}
