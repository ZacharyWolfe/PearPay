...
struct DetailViewCreditCard_Previews: PreviewProvider {
    static var previews: some View {
        DetailViewCreditCard(showDetailCreditCardView: .constant(false))
    }
}
